...
func TestQuadRecall_Scale_SmallProject_5Memories(t *testing.T) {
	...
	mems, attr := srv.quadRecallSearch(context.Background(), "auth token validation", 5, false, 7)
...
func TestQuadRecall_Scale_MediumProject_100Memories(t *testing.T) {
	...
	mems, attr := srv.quadRecallSearch(context.Background(), "auth token JWT validation", 5, false, 7)
...
func TestQuadRecall_Scale_LargeProject_1000Memories(t *testing.T) {
	...
	mems, attr := srv.quadRecallSearch(context.Background(), "auth JWT token", 5, false, 7)
...
func TestQuadRecall_Scale_LargeProject_TemporalStillUseful(t *testing.T) {
	...
	mems, _ := srv.quadRecallSearch(context.Background(), "auth JWT signing", 5, false, 7)
...
func TestQuadRecall_Scale_EmptyProject(t *testing.T) {
	srv := newTestServer(t)
	mems, attr := srv.quadRecallSearch(context.Background(), "auth", 5, false, 7)
	if len(mems) != 0 {
...
func TestQuadRecall_Scale_AllMemoriesRelevant(t *testing.T) {
	...
	mems, _ := srv.quadRecallSearch(context.Background(), "auth handler", 5, false, 7)
