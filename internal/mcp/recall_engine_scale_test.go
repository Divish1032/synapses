...
func TestQuadRecall_Scale_SmallProject_5Memories(t *testing.T) {
	...
	mems, attr, _, _ := srv.quadRecallSearch(context.Background(), "auth token validation", "", 5, false, 7, nil, 0)
...
func TestQuadRecall_Scale_MediumProject_100Memories(t *testing.T) {
	...
	mems, attr, _, _ := srv.quadRecallSearch(context.Background(), "auth token JWT validation", "", 5, false, 7, nil, 0)
...
func TestQuadRecall_Scale_LargeProject_1000Memories(t *testing.T) {
	...
	mems, attr, _, _ := srv.quadRecallSearch(context.Background(), "auth JWT token", "", 5, false, 7, nil, 0)
...
func TestQuadRecall_Scale_EmptyProject(t *testing.T) {
	srv := newTestServer(t)
	mems, attr, _, _ := srv.quadRecallSearch(context.Background(), "auth", "", 5, false, 7, nil, 0)
	if len(mems) != 0 {
...
func TestQuadRecall_Scale_AllMemoriesRelevant(t *testing.T) {
	...
	mems, _, _, _ := srv.quadRecallSearch(context.Background(), "auth handler", "", 5, false, 7, nil, 0)
